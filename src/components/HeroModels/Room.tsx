...
export function Room(props = {} as Partial<Group>) { // props are optional
  const { nodes, materials } = useGLTF('/models/optimized-room.glb') as unknown as { nodes: { [key: string]: Mesh }, materials: { [key: string]: any } }
  return (
